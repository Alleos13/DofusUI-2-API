package d2network
{
   public class FightResultExperienceData extends FightResultAdditionalData
   {
      ...
      public function get experienceFightDelta() : int
      {
      ...
      public function get experienceForGuild() : uint
      {
      ...
      public function get experienceForMount() : uint
      {
      ...
      public function get rerollExperienceMul() : int
      {
